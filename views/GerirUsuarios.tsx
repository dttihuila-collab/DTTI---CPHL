    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-semibold text-gray-800">Gerir Usuários</h2>
                        ...
                        {users.map(user => (
                            <tr key={user.id} className="bg-white border-b hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4 text-right space-x-2">
                                    <button onClick={() => openModal(user)} className="text-custom-blue-600 hover:text-custom-blue-800"><EditIcon /></button>
                                    <button onClick={() => openDeleteModal(user)} className="text-red-600 hover:text-red-800"><DeleteIcon /></button>
                                </td>
                            </tr>
                        ))}
                    </tbody>

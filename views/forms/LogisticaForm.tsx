...
const LogisticaForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        setSuccessMessage('Dados de logística submetidos com sucesso!');
        form.reset();
    ...
    return (
        <FormWrapper
            title="Registo de Logística"
            description="Registe informações sobre logística, combustíveis e distribuição."
